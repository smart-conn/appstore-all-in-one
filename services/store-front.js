...
module.exports = function(app) {
  const repo = [{
    ...
    }, { "id": "b7f4e964.480b18", "type": "debug", "name": "", "active": true, "console": "false", "complete": "false", "x": 393.0994415283203, "y": 233.09091186523438, "z": "fe309029.01cf7", "wires": [] }]
  }, {
    ...
    }, { "id": "e4fbc5c7.1b0438", "type": "http response", "name": "", "x": 655.8888854980469, "y": 141.88888549804688, "z": "3595e52c.ca6a1a", "wires": [] }]
  }];
  ...
  //查找某用户所有的设备
  amqp.on("app.findAllDeviceByID", (msg, callback) => {
    console.log(msg.id);
    callback(null, [
      { id: "008746223A15", name: "baby" },
      { id: "12345645", name: "wawa" }
    ]);
  });
};

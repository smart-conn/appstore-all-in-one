...
module.exports = (application) => {
  ...
  //应用商店所有APP
  router.get("/appStore/apps", application.authCheck('custmer'), function* () {
    console.log(this.req.user);
    this.body = yield amqp.call('appStore.apps');
  });

  router.get("/appStore/app/:id", application.authCheck('custmer'), function* () {
  ...
  router.get("/findAllDevice", application.authCheck('custmer'), function* () {
